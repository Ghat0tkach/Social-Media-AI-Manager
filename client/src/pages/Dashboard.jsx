  ...
  return (
    <section className="max-w-7xl mt-20 mx-auto">
      <div className="text-center">
        <h1 className="font-extrabold text-[#222328] text-4xl">Dashboard</h1>
        <p className="mt-2 text-[#666e75] text-lg max-w-md mx-auto">
          Browse through a collection of imaginative and visually stunning images
          generated by DALL-E AI and crafted by You
        </p>
      </div>
